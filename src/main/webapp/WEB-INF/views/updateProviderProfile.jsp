...
<body>
	...
	<form:form id="myForm" method="post"
		action="processUpdateProviderProfile" commandName="provider"
		...
		<fieldset>
			...
			<!-- Start of provider specific table -->
			<table class="providerInformation">
				<tr>
					<th><label><b>***PROVIDER***</b></label></th>
				</tr>
				<tr>
				...
				<tr>
					...
					<th><form:select path="department">
							...
							<form:option value="pediatrics" label="Pediatrics"/>
